<template>
  <div>
    ...
    <CCard>
      <CCardHeader>
        <CRow>
          <CCol md="9"><h3>Thống kê sách</h3></CCol>
          <CCol md="3">
            <CRow>
              <CCol  >
                <CInput
      ...
      <CCardBody>
        <CRow>
          ...
          <CCol sm="12" lg="12">
            <CWidgetProgress
              header="Alfred's Basic Adult Piano Course: Sacred Book 1"
              text="G. Wakeling"
                ...
                <CCol sm="10" lg="10">
                  <CRow>
                    <CCol col="12" sm="12" lg="6">
                      <CWidgetDropdown
                        :header="`đ${9811100} - đ${70.000}`"
                        text="IMPORT COST - REVENUE"
      ...
      <CCardBody>
        <CRow>
          <CCol sm="5">
            ...
            <div class="small text-muted">This month ({{new Date()}})</div>
          </CCol>
